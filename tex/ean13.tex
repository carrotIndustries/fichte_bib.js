...
\def\EANrepeat#1#2{\if#1.\let\next=\EANfinal \else\let\next=\EANrepeat
  ...
  \workdimen=#2\X \advance\workdimen by-\bcorr \vrule width\workdimen
     \ifdim\barheight=0pt height 35.14\X \else height\barheight \fi
...
\def\EANfinal{\testconsistence
  ...
  \egroup \global\barheight=0pt \gdef\ISBNnum{} \vspace{5mm}}
...
%\barheight=1cm
\def\ISBNnum{}
\def\ISBN #1 {\def\ISBNnum{ISBN #1}\barheight=40.151515\X\relax}
